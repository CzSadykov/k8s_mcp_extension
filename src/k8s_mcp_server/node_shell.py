...
from k8s_mcp_server.node_logs import LogAnalyzer, NodeLogCollectionRequest, NodeLogCommandBuilder
...
class NodeDiagnosticsService:
    ...
    async def run_checkup(self, node_name: str, timeout: int | None = None) -> CommandResult:
